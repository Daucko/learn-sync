          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {subjects.map((subject) => (
                <Card
                  key={subject.id}
                  className="overflow-hidden transition-shadow hover:shadow-lg bg-gray-100"
                >
                  ...
                  <CardFooter className="p-4 bg-gray-100 grid grid-cols-2 gap-2">
                    <Button
                      variant="outline"
                      className="h-10 gap-2 bg-white hover:bg-gray-200 cursor-pointer"
                    >
